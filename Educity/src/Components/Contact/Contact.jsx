...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "61570399-676e-4577-a325-eded4fdb7365");
  ...
  return (
    <div className='contact'>
        <div className="contact-col"> 
            ...
            <ul>
                <li><img src={mail_icon} alt="" />piyushaadesai@gmail.com</li>
                <li><img src={phone_icon} alt="" />+91 7709748760</li>
                <li><img  alt="" /><br/></li>
            </ul>
        </div>
        <div className="contact-col"> 
